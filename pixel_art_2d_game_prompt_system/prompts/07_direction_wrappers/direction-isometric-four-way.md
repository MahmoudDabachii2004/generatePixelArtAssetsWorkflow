---
id: "07_direction_wrappers/direction-isometric-four-way"
title: "Direction Isometric Four Way"
...
# Direction Isometric Four Way

## Purpose

Directional consistency wrapper composed with another asset or animation prompt. Target: Direction Isometric Four Way.
...
SPECIFIC TASK: **Direction Isometric Four Way**
...
- Use the canonical order S, W, E, N unless {{OUTPUT_LAYOUT}} overrides it.
- Keep proportions, equipment, palette, and lighting coherent across all four views.
