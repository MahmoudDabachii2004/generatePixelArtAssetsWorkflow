---
id: "23_ui/ui-window-frame-nine-slice"
title: "Ui Window Frame Nine Slice"
category: "23_ui"
kind: "generation"
version: "1.0.0"
...
# Ui Window Frame Nine Slice

## Purpose

Pixel-art user-interface component prompt. Target: Ui Window Frame Nine Slice.
...
SPECIFIC TASK: **Ui Window Frame Nine Slice**
...
- Keep four corners immutable, make edge regions repeatable or stretch-safe, and keep the center fill texture free of unique focal details.
