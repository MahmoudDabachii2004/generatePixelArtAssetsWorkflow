---
id: "30_transitions/transition-run-to-stop"
title: "Transition Run To Stop"
...
# Transition Run To Stop

## Purpose

State-to-state animation transition prompt. Target: Transition Run To Stop.
...
SPECIFIC TASK: **Transition Run To Stop**
