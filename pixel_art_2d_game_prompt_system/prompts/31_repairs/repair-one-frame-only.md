---
id: "31_repairs/repair-one-frame-only"
title: "Repair One Frame Only"
category: "31_repairs"
kind: "repair"
version: "1.0.0"
...
# Repair One Frame Only

## Purpose

Surgical correction prompt that preserves successful output. Target: Repair One Frame Only.
...
REPAIR TASK: **Repair One Frame Only**
...
- Use the adjacent valid frames and the immutable reference to reconstruct only the defective frame.
- Do not change frame count, timing, or any other frame.
