---
id: "32_processing/process-chroma-key"
title: "Process Chroma Key"
...
Deterministic post-processing specification for the application. Target: Process Chroma Key.
...
You are executing the deterministic pipeline operation: **Process Chroma Key**.
