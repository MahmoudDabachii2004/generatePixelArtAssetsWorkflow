---
id: "32_processing/process-export-engine-metadata"
title: "Process Export Engine Metadata"
...
# Process Export Engine Metadata

## Purpose

Deterministic post-processing specification for the application. Target: Process Export Engine Metadata.
...
You are executing the deterministic pipeline operation: **Process Export Engine Metadata**.
