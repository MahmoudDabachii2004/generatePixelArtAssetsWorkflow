---
id: "32_processing/process-remove-duplicate-frames"
title: "Process Remove Duplicate Frames"
...
# Process Remove Duplicate Frames

## Purpose

Deterministic post-processing specification for the application. Target: Process Remove Duplicate Frames.
...
You are executing the deterministic pipeline operation: **Process Remove Duplicate Frames**.
