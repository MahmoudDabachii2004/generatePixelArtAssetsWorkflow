---
id: "20_vfx/vfx-environmental-particle-loop"
title: "Vfx Environmental Particle Loop"
category: "20_vfx"
kind: "animation"
version: "1.0.0"
...
# Vfx Environmental Particle Loop

## Purpose

Isolated visual-effect prompt. Target: Vfx Environmental Particle Loop.
...
SPECIFIC TASK: **Vfx Environmental Particle Loop**
...
TASK-SPECIFIC RULES:
- Use a transparent or chroma-keyed isolated canvas with no baked scene.
- Keep the effect readable at gameplay scale and align its origin to the stated hit, muzzle, caster, or world point.
- Do not alter the referenced character or weapon while generating an isolated effect.
