---
id: "05_character_animation/anim-idle-subtle-loop"
title: "Anim Idle Subtle Loop"
...
# Anim Idle Subtle Loop

## Purpose

Character gameplay animation prompt. Target: Anim Idle Subtle Loop.
...
SPECIFIC TASK: **Anim Idle Subtle Loop**
...
- Use the proven eight-pose circular breathing structure P0→P1→P2→P3→P4→P5→P6→P7→P0.
- Keep feet, face, head position, scale, canvas, and background fixed; change only a tiny number of internal chest, scarf, or optional hair-tip pixels.
- At 24 FPS, default to three video frames per pose for one 24-frame master cycle, then repeat it identically.
