---
id: "05_character_animation/anim-crouch-walk-loop"
title: "Anim Crouch Walk Loop"
...
# Anim Crouch Walk Loop

## Purpose

Character gameplay animation prompt. Target: Anim Crouch Walk Loop.
...
SPECIFIC TASK: **Anim Crouch Walk Loop**
...
- Alternate left and right foot contacts with readable passing poses and opposition between arms and legs.
- Keep the root anchor fixed for an in-place sprite-sheet loop unless {{ROOT_MOTION_POLICY}} explicitly requests displacement.
- Match the first-to-last phase gap to every other adjacent phase gap.
