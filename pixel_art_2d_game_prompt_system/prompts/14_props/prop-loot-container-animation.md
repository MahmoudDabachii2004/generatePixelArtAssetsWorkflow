---
id: "14_props/prop-loot-container-animation"
title: "Prop Loot Container Animation"
category: "14_props"
kind: "animation"
version: "1.0.0"
...
# Prop Loot Container Animation

## Purpose

Reusable environment prop prompt. Target: Prop Loot Container Animation.
...
SPECIFIC TASK: **Prop Loot Container Animation**
...
TASK-SPECIFIC RULES:
- Use a reusable isolated asset with a stable baseline and no baked scenery unless requested.
- Keep interactive states aligned so the prop does not jump when its state changes.
