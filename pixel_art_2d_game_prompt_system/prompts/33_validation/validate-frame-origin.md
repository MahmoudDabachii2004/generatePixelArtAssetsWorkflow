---
id: "33_validation/validate-frame-origin"
title: "Validate Frame Origin"
...
Automated validation specification. Target: Validate Frame Origin.
...
Validate the asset using the specification: **Validate Frame Origin**.
