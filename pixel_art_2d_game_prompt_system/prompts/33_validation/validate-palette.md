---
id: "33_validation/validate-palette"
title: "Validate Palette"
...
Automated validation specification. Target: Validate Palette.
...
Validate the asset using the specification: **Validate Palette**.
