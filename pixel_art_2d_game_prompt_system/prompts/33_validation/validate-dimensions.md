---
id: "33_validation/validate-dimensions"
...
Automated validation specification. Target: Validate Dimensions.
...
Validate the asset using the specification: **Validate Dimensions**.
